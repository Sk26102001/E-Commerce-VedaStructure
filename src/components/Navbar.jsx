...
//             <Link to="veda-store/gemsstones" className="block px-4 py-2 hover:bg-orange-100">Gemstone</Link>
  ...
  return (
    <header className="top-0 z-50 w-full shadow-md bg-white">
      ...
      <div className="hidden md:flex justify-center items-center space-x-8 font-semibold text-base text-gray-700 px-4 py-3">
        ...
        <Link to="/talk-to-astrologer" className="hover:text-orange-400 transition">
          Talk To Astrologer
        </Link>
        ...
        <div className="relative group">
          ...
          <div className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-md hidden group-hover:block z-50 border border-gray-200 border-t-4 border-t-orange-500">
            <Link to="/puja/all" className="block px-4 py-2 hover:bg-orange-100">
              All Puja
            </Link>
            <Link to="/puja/yagya" className="block px-4 py-2 hover:bg-orange-100">
              Yagya Puja
            </Link>
          </div>
        </div>
        ...
        <div className="relative group">
          ...
          <div className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-md hidden group-hover:block z-50 border border-gray-200 border-t-4 border-t-orange-500">
            <Link to="/astro-report/basic" className="block px-4 py-2 hover:bg-orange-100">
              Basic Report
            </Link>
            <Link to="/astro-report/detailed" className="block px-4 py-2 hover:bg-orange-100">
              Detailed Report
            </Link>
          </div>
        </div>
        ...
        <div className="relative group">
          ...
          <div className="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-md hidden group-hover:block z-50 border border-gray-200 border-t-4 border-t-orange-500">
            <Link to="/veda-store/explore-all" className="block px-4 py-2 hover:bg-orange-100">
              Explore All
            </Link>
            <Link to="/veda-store/rudraksha" className="block px-4 py-2 hover:bg-orange-100">
              Rudraksha
            </Link>
            <Link to="/veda-store/gemsstones" className="block px-4 py-2 hover:bg-orange-100">
              Gemstone
            </Link>
          </div>
        </div>

        <Link to="/astrology-courses" className="hover:text-orange-400 transition">
          Astrology Courses
        </Link>
        <Link to="/article" className="hover:text-orange-400 transition">
          Article
        </Link>
      ...
      >
        <div className="flex items-center justify-between px-4 py-3 border-b">
          ...
          <button onClick={() => setIsOpen(false)} className="text-gray-700 hover:text-orange-500 text-2xl">
            ✕
          </button>
        </div>

        <nav className="flex flex-col space-y-3 px-4 py-3 font-semibold text-gray-700">
          <Link to="/" onClick={() => setIsOpen(false)} className="py-2 px-4 rounded-md hover:bg-orange-500 hover:text-white transition">
            Home
          </Link>
          <Link to="/talk-to-astrologer" onClick={() => setIsOpen(false)} className="py-2 px-4 rounded-md hover:bg-orange-500 hover:text-white transition">
            Talk To Astrologer
          </Link>
          <Link to="/astrology-courses" onClick={() => setIsOpen(false)} className="hover:text-orange-500">
            Astrology Courses
          </Link>
