...
const generateCurriculum = (title, duration, category) => {
  ...
  const baseModule = {
    Astrology: [
      "Foundations: Planets & Signs",
      "Houses & Aspects",
      "Dasha Systems & Timing",
      "Remedies & Case Studies",
    ],
    "Vastu & Space": [
      "Elements & Directions",
      "Zoning & Energy Mapping",
      "Remedial Vastu",
      "Case Study Audits",
    ],
    "Language & Texts": [
      "Alphabet & Pronunciation",
      "Basic Grammar (Vyakarana)",
    ...
    Philosophy: [
      "Core Concepts (Karma, Dharma)",
      "Upanishad/Veda Overview",
  ...
  while (curriculum.length < 3) {
    curriculum.push({
      module: `Week ${curriculum.length + 1}:`,
      title: `Core Module ${curriculum.length + 1}`,
    });
  }
  return curriculum;
};
...
const enrichCourseDetails = (baseCourse) => {
  ...
  let targetAudience = [];
  if (
    baseCourse.tag === "Best Seller" ||
    baseCourse.tag === "Foundation" ||
    id % 2 === 1
  ) {
    targetAudience = [
      "Absolute Beginners with no prior knowledge.",
      "Individuals seeking deep self-knowledge.",
      "Anyone aspiring for a certified practice.",
    ];
  } else {
    targetAudience = [
      "Intermediate Learners looking to specialize.",
      "Practitioners of related disciplines.",
      "Those looking for practical, skill-based learning.",
    ];
  }
  ...
  if (keyTakeaways.length < 4 && curriculum.length > 0) {
    keyTakeaways = keyTakeaways.concat(
      curriculum.slice(0, 4 - keyTakeaways.length).map((m) => m.title)
    );
  }
  ...
  const fullDescription =
    {
      "Vedic Astrology":
        "This comprehensive course on Vedic Astrology (Jyotish) is designed for serious seekers who want to go beyond general readings. You will learn the deep philosophical and mathematical principles behind planetary positions, house meanings, and the powerful Dasha systems. Master the art of prediction and apply effective, traditional remedies (Upayas) to transform life challenges into opportunities for growth. It is a certified practitioner course that gives you the knowledge to start your own practice.",
      "Vastu Shastra":
        "Discover the ancient science of Vastu Shastra to harmonize your living and working spaces. Learn to balance the five elements, understand directional energies, and implement practical remedies without major structural changes. This course covers everything from site selection to internal room arrangement for maximum prosperity and wellbeing.",
      "Sanskrit Vyakarana":
        "A foundational yet rigorous study of Sanskrit grammar (Vyakarana). You will master verb conjugations, noun declensions, and sentence structure, enabling you to read and understand original scriptural texts directly. Essential for any serious Vedic student.",
      "Mantra Healing":
        "An intense therapeutic course focusing on the power of sound. Learn to use Beej Mantras and specific sonic frequencies to balance the chakras, clear energetic blockages, and promote holistic healing for yourself and others. This is a practical, result-oriented program.",
    }[title] ||
    `Dive deep into the ${title} tradition. This ${duration.toLowerCase()} course offers a blend of ancient wisdom and modern application, covering all the core principles you need for mastery in the field of ${category}.`;

  const instructorDetails = {
    experience: `${category} Expert | ${
      Math.ceil(id / 3) + 10
    }+ Years Experience`,
    specialty: title.includes("Vedic")
      ? "Traditional Vedic Texts & Principles"
      : `Practical Application of ${category}`,
...
const staticCourses = [
  {
    ...
    headline: "Decode the Secrets of Your Kundali through Ancient Jyotish",
    price: 5999,
    originalPrice: 12000,
    ...
    rating: 5.0,
    faculty: "Acharya Devi",
    isRecommended: true,
    category: "Astrology",
    tag: "Best Seller",
    thumbnail: "./Vedic_Astrology_Course_Instructor.mp4",
    facultyImage: getFacultyImageUrl("Acharya Devi"),
  },
  {
    id: 2,
    title: "Palmistry (Hastrekha)",
    headline: "Your Destiny Lies in Your Hands – Learn the Art of Palmistry",
    price: 2499,
    originalPrice: 5000,
    duration: "4 Weeks Self-Paced",
    path: "/palmistry",
    benefits: ["Lifetime Access", "Official Certificate", "Practice Handouts"],
    rating: 4.8,
    faculty: "Guru Gopal",
    isRecommended: true,
    category: "Astrology",
    tag: "New",
    thumbnail:
      "https://i.ytimg.com/vi/NODpGnZnLNY/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLBD1YPfB5KPLk5CqpiTnPdiyXW1Uw",
    facultyImage: getFacultyImageUrl("Guru Gopal"),
  },
  {
    id: 3,
    title: "Numerology",
    headline: "Numbers Don’t Lie – Unlock Destiny Through Moolank & Bhagyank",
    price: 1999,
    originalPrice: 4000,
    ...
    tag: "Popular",
    thumbnail:
      "https://schoolofoccultscience.com/uploads/1720718433_Numerology%20Grid.png",
    facultyImage: getFacultyImageUrl("Acharya Devi"),
  },
  {
    id: 4,
    title: "Vastu Shastra",
    headline: "Balance Your Space, Balance Your Life with Vastu",
    price: 3499,
    originalPrice: 7000,
    duration: "6 Weeks Live + Case Studies",
    path: "/vastu",
    benefits: [
      "Lifetime Access",
      "Official Certificate",
    ...
    tag: "Trending",
    thumbnail:
      "https://www.vastumiracles.com/cdn/shop/articles/vastu_large.jpg?v=1608715271",
    facultyImage: getFacultyImageUrl("Dr. Sharma"),
  },
  {
    id: 5,
    title: "Sanskrit Vyakarana",
    headline: "Master the Grammar of Devabhasha – Sanskrit from the Roots",
    price: 999,
    originalPrice: 2000,
    ...
    tag: "Low Price",
    thumbnail:
      "https://i0.wp.com/knowledgegallery.in/wp-content/uploads/2022/03/Sanskrit-grammar.png?fit=500%2C320&ssl=1",
    facultyImage: getFacultyImageUrl("Pandit Ravi"),
  },
  {
    id: 6,
    title: "Daily Puja Routine",
    headline: "Learn Nitya Puja – Step-by-Step Rituals for Modern Life",
    price: 1499,
    originalPrice: 3000,
    duration: "2 Weeks Quick Start",
    path: "/dailypuja",
    benefits: ["Lifetime Access", "Official Certificate", "Puja Mantras Guide"],
    rating: 4.6,
    faculty: "Guru Gopal",
    isRecommended: false,
    category: "Mantra & Rituals",
    tag: "Quick Start",
    thumbnail:
      "https://hemfragrances.in/cdn/shop/articles/how-to-perform-daily-pooja.jpg?crop=center&height=1200&v=1753445859&width=1200",
    facultyImage: getFacultyImageUrl("Guru Gopal"),
  },
  {
    id: 7,
    title: "Muhurtas",
    headline: "Right Time, Right Action – Science of Shubh Muhurta",
    price: 2999,
    originalPrice: 6000,
    duration: "5 Weeks Specialist",
    path: "/muhurtas",
    benefits: [
      "Lifetime Access",
      "Official Certificate",
      "Muhurta Calculation Software Access",
    ],
    rating: 4.8,
    faculty: "Dr. Sharma",
    isRecommended: true,
    ...
    tag: "Specialist",
    thumbnail:
      "https://www.chamundaswamiji.com/wp-content/uploads/2021/06/mahurat.jpg",
    facultyImage: getFacultyImageUrl("Dr. Sharma"),
  },
  {
    id: 8,
    title: "Upanishads",
    headline: "Dive Deep into the Philosophy of Self & Brahman",
    price: 4999,
    originalPrice: 10000,
    duration: "8 Weeks Philosophical",
    path: "/upanishads",
    benefits: [
      "Lifetime Access",
      "Official Certificate",
    ...
    category: "Philosophy",
    tag: "Deep Dive",
    thumbnail: "https://www.esamskriti.com/essays/docfile/918.jpg",
    facultyImage: getFacultyImageUrl("Pandit Ravi"),
  },
  {
    id: 9,
    title: "Vedas",
    headline:
      "Foundations of Eternal Knowledge – Study Rig, Yajur, Sama, Atharva",
    price: 6999,
    originalPrice: 15000,
    ...
    tag: "Advanced",
    thumbnail:
      "https://preview.redd.it/i-wanna-read-the-vedas-what-source-of-books-should-i-read-v0-1j0oug99wqza1.jpg?width=1080&crop=smart&auto=webp&s=184d7fd6417502f43588e6c474fc71d2349e4b01",
    facultyImage: getFacultyImageUrl("Acharya Devi"),
  },
  {
    id: 10,
    title: "Purana & Itihas",
    headline: "Decode Ramayana, Mahabharata & the Puranas with Context",
    price: 1999,
    originalPrice: 4000,
    duration: "4 Weeks Historical",
    path: "/purana",
    benefits: [
      "Lifetime Access",
      "Official Certificate",
    ...
    tag: "History",
    thumbnail: "https://i.ytimg.com/vi/ZBWno70ThhE/maxresdefault.jpg",
    facultyImage: getFacultyImageUrl("Guru Gopal"),
  },
  {
    id: 11,
    title: "Vedic Mathematics",
    headline: "Ancient Maths Tricks for Fast Calculation & Logical Thinking",
    price: 999,
    originalPrice: 2000,
    duration: "3 Weeks Skills Course",
    path: "/mathematics",
    benefits: [
      "Lifetime Access",
      "Official Certificate",
    ...
    tag: "Low Price",
    thumbnail: "https://abacusmaster.com/blog/images/1112/Vedic-Math.jpg",
    facultyImage: getFacultyImageUrl("Dr. Sharma"),
  },
  {
    id: 12,
    title: "Mantra Healing",
    headline: "Heal Body, Mind & Soul Through Beej Mantras & Frequencies",
    price: 3999,
    originalPrice: 8000,
    duration: "6 Weeks Therapeutic",
    path: "/mantra",
    benefits: [
      "Lifetime Access",
      "Official Certificate",
      "Personalised Mantra Recommendation",
    ],
    rating: 4.8,
    faculty: "Acharya Devi",
    isRecommended: true,
    ...
    tag: "Healing",
    thumbnail:
      "https://healingwithram.in/wp-content/uploads/2025/09/mantras-for-healing-1.png",
    facultyImage: getFacultyImageUrl("Acharya Devi"),
  },
  {
    id: 13,
    title: "Sanskrit (Reading + Chanting)",
    headline: "Speak the Language of the Gods – Chant with Clarity",
    price: 1499,
    originalPrice: 3000,
    duration: "4 Weeks Practice",
    path: "/sanskritread",
    benefits: [
      "Lifetime Access",
      "Official Certificate",
    ...
    tag: "Quick Start",
    thumbnail:
      "https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/themes/2149308684/settings_images/wjng9n8QICTFg2w78HdQ_Sanscrit_B.png",
    facultyImage: getFacultyImageUrl("Pandit Ravi"),
  },
  {
    id: 14,
    title: "Sacred Texts Reading",
    headline: "Scriptural Reading Practice: Geeta, Hanuman Chalisa, etc.",
    price: 999,
    originalPrice: 2000,
    duration: "2 Weeks Focused",
    path: "/sacredtexts",
    benefits: [
      "Lifetime Access",
      "Official Certificate",
    ...
    tag: "Low Price",
    thumbnail:
      "https://www.focolaremedia.com/sites/default/files/styles/article_page_featured_image/public/2024-04/Website%20images%20_0.jpg?itok=-iLrs_Q4",
    facultyImage: getFacultyImageUrl("Guru Gopal"),
  },
  {
    id: 15,
    title: "Vedic Science",
    headline: "Hidden Scientific Concepts in Agni, Ether, Time & Creation",
    price: 4999,
    originalPrice: 10000,
    duration: "7 Weeks Advanced",
    path: "/vedicscience",
    benefits: [
      "Lifetime Access",
      "Official Certificate",
      "Science vs Text Comparison",
    ],
    rating: 4.9,
    faculty: "Dr. Sharma",
    isRecommended: true,
    ...
    tag: "Advanced",
    thumbnail:
      "https://vedicuniversity.online/gallery_gen/49703b6abece7c8a19930f8a923d0c60_1642x1028_fit.jpg?ts=1759859580",
    facultyImage: getFacultyImageUrl("Dr. Sharma"),
  },
  {
    id: 16,
    title: "Vedic Philosophy",
    headline: "Understand Karma, Dharma, Rebirth, Moksha from Vedic Lens",
    price: 2999,
    originalPrice: 6000,
    duration: "5 Weeks Foundation",
    path: "/vedicphilosophy",
    benefits: [
      "Lifetime Access",
      "Official Certificate",
      "Key Sutra Summaries",
    ...
    tag: "Foundation",
    thumbnail:
      "https://cn.edurev.in/ApplicationImages/Temp/12058070_dea7d419-77ab-4d7e-b37e-6d3e5fa993d9_lg.png?w=400&dpr=2.6",
    facultyImage: getFacultyImageUrl("Pandit Ravi"),
  },
...
const CourseCard = ({
  ...
  const facultyImage =
    course.facultyImage || getFacultyImageUrl(course.faculty);
  ...
  const thumbnailContent = isThumbnailVideo ? (
    <video
      ...
      onError={(e) => {
        ...
        e.target.src =
          "https://placehold.co/600x350/ffefe1/b45309?text=Image+Placeholder";
        e.target.closest(
          "div"
        ).innerHTML = `<img src="https://placehold.co/600x350/ffefe1/b45309?text=Image+Placeholder" alt="${course.title}" className="w-full h-48 object-cover group-hover:scale-105 transition duration-500" />`;
      }}
    />
  ) : (
    <img
      ...
      onError={(e) => {
        e.target.onerror = null;
        e.target.src =
          "https://placehold.co/600x350/cccccc/333333?text=Image+Error";
      }}
    />
  );
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden">
        {thumbnailContent}
        <div
          className={`absolute left-4 bottom-4 bg-orange-600 text-white px-3 py-1 rounded-full text-xs font-semibold shadow-md ${
            course.isRecommended ? "bg-green-600" : ""
          }`}
        >
        ...
        <div className="flex items-center justify-between text-sm text-gray-500 mb-4 border-t pt-4">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500">
            <img
              src={facultyImage}
              alt={course.faculty}
              className="w-15 h-15 rounded-full object-cover border-2 border-orange-300 shadow-sm"
              onError={(e) => {
                e.target.onerror = null;
                e.target.src = "https://placehold.co/32x32/ff7e00/fff?text=F";
              }}
            />
            By{" "}
...
const CategoryFilterCombobox = ({ value, onChange, options }) => {
  ...
  const handleInputChange = (e) => {
    ...
    const perfectMatch = options.find(
      (opt) => opt.toLowerCase() === newSearchTerm.toLowerCase()
    );
    if (perfectMatch) {
  ...
  return (
    <div className="relative w-full md:w-1/3" ref={filterRef}>
      ...
      {searchTerm && value !== "All" ? (
        <button
          onClick={handleClear}
          className="absolute right-3 top-2.5 text-gray-500 hover:text-red-500 transition p-1"
        >
          <X size={18} />
        </button>
      ) : (
...
const CourseDetailsPage = ({
  ...
  const fullDescription =
    ...
    "A comprehensive and transformative learning journey designed to unlock the ancient wisdom of this sacred tradition.";
      ...
      <div className="w-full max-w-5xl mx-auto">
        ...
        >
            ...
            {isMediaVideo ? (
              <video
                ...
                onError={(e) => {
                  ...
                  e.target.closest(
                    "div"
                  ).innerHTML = `<img src="https://placehold.co/800x400/ffefe1/b45309?text=Video+Unavailable+-+Course+Preview" alt="Course Preview" className="w-full h-96 object-cover object-top" />`;
                }}
              />
            ) : (
              <img
                ...
                onError={(e) => {
                  e.target.onerror = null;
                  e.target.src =
                    "https://placehold.co/800x400/cccccc/333333?text=Image+Error";
                }}
              />
            )}
          ...
          <div className="p-8 md:p-12">
            ...
            {/* Faculty & Rating Row */}
            <div className="grid items-center gap-6 border-b pb-4 mb-6">
              <div className="flex items-center gap-3 text-lg font-semibold text-gray-700">
                <img
                  src={course.facultyImage}
                  alt={course.faculty}
                  className=" w-20 h-20 rounded-full object-cover border-2 border-yellow-500 shadow-md"
                />
                Taught By:{" "}
                <span className="text-orange-600">{course.faculty}</span>
              </div>
            ...
            <div className="mb-10">
              <h2 className="text-2xl font-bold text-orange-700 mb-4 flex items-center gap-2 border-b pb-2">
                <BookOpen size={24} className="text-orange-500" /> Course
                Overview
              </h2>
              ...
              <h3 className="text-xl font-bold text-orange-600 mb-3 flex items-center gap-2">
                <Zap size={20} className="text-yellow-500" /> What You Will
                Master
              </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                <h2 className="text-2xl font-bold text-orange-700 mb-4 flex items-center gap-2 border-b pb-2">
                  <Calendar size={20} className="text-orange-500" /> Curriculum
                  Breakdown
                </h2>
                <ul className="space-y-3 mb-4">
                  {curriculum.map((item, index) => (
                    <li
                      key={index}
                      className="p-3 bg-orange-50 rounded-lg border-l-4 border-orange-400 shadow-sm"
                    >
...
>
  View Detailed Lesson List &rarr;
                ...
                <div>
                  ...
                  <Link
                    to={course.path || "/CoursedetailsPage"}
                    type="button"
                    className="inline-block text-orange-600 hover:text-orange-800 font-semibold transition mt-2"
                  >
                    View Detailed Lesson List &rarr;
              ...
              <div className="bg-orange-50 p-6 rounded-xl shadow-inner flex flex-col justify-between">
                <div className="space-y-4 mb-6">
                  <h3 className="text-xl font-bold text-orange-700 flex items-center gap-2">
                    <User size={20} className="text-orange-500" /> Key
                    Information
                  </h3>
                  <div className="flex items-center text-gray-700">
                    <Clock size={20} className="text-orange-400 mr-3" />
                    <span className=" flex font-semibold">Duration:</span>{" "}
                    {course.duration}
                  </div>
                  <div className="flex items-center text-gray-700">
                  ...
                  <div className="flex items-center text-gray-700">
                    ...
                    {targetAudience[0] || "Beginners & Intermediate Learners"}
                  </div>
                </div>
            ...
            <div className="mt-10 pt-8 border-t border-gray-200">
              <h2 className="text-3xl font-extrabold text-orange-800 mb-6 flex items-center gap-3">
                <User size={30} className="text-yellow-500" /> About The
                Instructor
              </h2>
              <div className="flex items-start bg-yellow-50 p-6 rounded-xl border border-yellow-300 shadow-md">
                <img
                  src={course.facultyImage}
                  alt={course.faculty}
                  className="w-24 h-24 rounded-full object-cover border-4 border-orange-300 shadow-lg mr-6 flex-shrink-0"
                />
                <div>
                  <h3 className="  text-2xl font-bold text-orange-700 mb-1">
                    {course.faculty}
                  </h3>
                  <p className=" flex text-lg text-gray-700 mb-3 font-medium">
                    {instructorDetails.experience ||
                      "Experienced Vedic Scholar"}
                  </p>
                  <ul className="text-gray-600 space-y-1 text-sm">
                    <li>
                      <span className="font-semibold">Specialty:</span>{" "}
                      {instructorDetails.specialty ||
                        "Traditional Vedic Sciences"}
                    </li>
                    <li>
                      <span className="font-semibold">Reach:</span>{" "}
                      {instructorDetails.clients ||
...
const CoursesPage = ({ onEnrollClick, onViewDetailsClick }) => {
  ...
  const isFeaturedVideo = featuredCourse.thumbnail
    .toLowerCase()
    .endsWith(".mp4");
  const featuredMediaContent = isFeaturedVideo ? (
    <video
      ...
      onError={(e) => {
        ...
        e.target.closest(
          "div"
        ).innerHTML = `<img src="https://placehold.co/600x420/ffefe1/b45309?text=Featured+Image+Placeholder" alt="Featured Course Image" className="w-full h-[300px] md:h-[420px] object-cover object-top" />`;
      }}
    />
  ) : (
    <img
      ...
      onError={(e) => {
        e.target.onerror = null;
        e.target.src =
          "https://placehold.co/600x420/cccccc/333333?text=Image+Error";
      }}
    />
  );
    ...
    <div className="bg-gradient-to-b from-orange-50 to-yellow-50 text-gray-900 min-h-screen font-sans">
      ...
      <header className="bg-gradient-to-r from-orange-600 to-yellow-500 shadow-lg py-12 text-center text-white">
        ...
        <p className="text-lg mt-3 opacity-90 max-w-2xl mx-auto">
          Deepen your spiritual and analytical mastery across Jyotish, Vastu,
          ...
          <div className="p-6 md:p-8 bg-orange-50">
            ...
            <div className="mt-4 flex flex-wrap gap-4 items-center">
              ...
              <span className="flex items-center gap-1 text-yellow-600 font-bold">
                ...
                {featuredCourse.rating.toFixed(1)} Rating
              </span>
              <button
          ...
          <div className="flex flex-col md:flex-row items-center gap-4">
            ...
            <div className="relative w-full md:w-1/3">
              <select
                ...
                className={`appearance-none border border-gray-300 rounded-xl px-4 py-2.5 pr-10 text-sm  font-medium cursor-pointer focus:ring-2 focus:ring-orange-400 transition w-full ${
                  sortBy === "recommended"
                    ? "bg-gradient-to-r from-orange-500 to-yellow-400 text-black"
                    : "hover:bg-gradient-to-r hover:from-orange-500 hover:to-yellow-400 hover:text-black text-gray-700 "
                }`}
              >
                <option className="bg-yellow-400" value="recommended">
                  ⭐ Recommended For You
                </option>
                <option className="bg-yellow-400 " value="ratingHigh">
                  Rating: High to Low
                </option>
                <option className="bg-yellow-400" value="priceLow">
                  Price: Low to High
                </option>
                <option className="bg-yellow-400" value="priceHigh">
                  Price: High to Low
                </option>
                <option className="bg-yellow-400" value="newest">
                  Newest Courses
                </option>
              </select>
...
const EnrollPage = ({ course, onBackToCourses }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        console.log(
          "Simulating navigation to Payment Page for:",
          courseData.title
        );
  ...
  const SuccessScreen = () => (
    ...
    >
      ...
      <p className="text-gray-600 mb-6">
        Thank you, **{formData.name}**! Your request for the **
        {courseData.title}** course is processed.
      </p>
      ...
      >
        ...
        <p className="text-gray-600 text-lg md:text-xl max-w-3xl text-center mx-auto mb-10">
          {isEnrolled
            ...
            : `Secure your seat and begin your spiritual journey with the ${courseData.title}.`}
        </p>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className={`appearance-none w-full px-4 py-3 pl-12 border rounded-xl bg-gray-50 focus:ring-2 focus:ring-yellow-400 outline-none transition text-gray-800 font-medium cursor-pointer pr-10 ${
                        loading ? "opacity-60" : "hover:border-orange-400"
                      }`}
                      disabled={loading}
                    >
