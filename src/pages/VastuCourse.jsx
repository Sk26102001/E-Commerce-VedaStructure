...
// const PRIMARY_COLOR = 'bg-green-600'; // Changed primary color to reflect nature/earth (Vastu)
// const ACCENT_COLOR = 'text-teal-700';
// const HOVER_COLOR = 'hover:bg-gradient-to-r from-green-600 to-teal-700';
// const BORDER_COLOR = 'border-teal-300';
...
//   return (
//     <div className="mb-3 rounded-xl overflow-hidden shadow-lg border border-teal-100">
//       {/* Accordion Header */}
//       <motion.button
...
//             className="overflow-hidden bg-white p-4 border-l-4 border-b-4 border-r-4 border-teal-200 rounded-b-xl"
//           >
...
//   return (
//     <div className="border-b border-teal-200 bg-white/60 backdrop-blur-md rounded-lg my-2 shadow-sm">
//       <button
//         onClick={() => setOpen(!open)}
//         className="w-full flex justify-between items-center py-4 px-4 text-left font-medium text-teal-700 hover:text-teal-800"
//       >
//         {title}
...
//           ${plan.isPopular ? 'bg-teal-600 text-white border-4 border-yellow-300' : 'bg-white text-gray-800 border-2 border-teal-100'} 
//           h-full flex flex-col`}
//     >
//         {plan.isPopular && (
//             <div className="absolute top-0 right-0 transform translate-y-[-50%] translate-x-1/4 bg-yellow-400 text-teal-800 text-xs font-bold px-4 py-1 rounded-full shadow-lg rotate-6">
//                 ✨ MOST POPULAR
//             </div>
//         )}
//         <h3 className={`text-3xl font-bold font-serif mb-4 ${plan.isPopular ? 'text-white' : 'text-teal-700'}`}>
//             {plan.name}
//         </h3>
//         <p className={`text-5xl font-extrabold mb-6 ${plan.isPopular ? 'text-yellow-300' : 'text-teal-800'}`}>
//             {plan.price}
//         </p>
...
//                     <CheckCircle2 
//                         className={`w-5 h-5 mr-2 flex-shrink-0 ${plan.isPopular ? 'text-yellow-300' : 'text-teal-600'}`} 
//                     />
...
//                   ${plan.isPopular 
//                       ? 'bg-yellow-300 text-teal-800 hover:bg-yellow-400' 
...
//   return (
//     <div className="font-sans text-gray-800 bg-gradient-to-b from-green-50 to-teal-50 overflow-hidden">
//       {/* Hero Section */}
//       <section className="relative flex flex-col justify-center items-center text-center py-24 px-6 overflow-hidden bg-gradient-to-r from-teal-100 via-green-50 to-teal-100">
//         <motion.div
...
//         >
//           <h1 className="text-5xl md:text-6xl font-serif text-green-800 drop-shadow-md leading-snug">
//             Harmonize Your Home & Life with <br />
//             <span className="text-teal-600">Ancient Vastu Shastra</span>
//           </h1>
...
//               className="bg-gradient-to-r from-green-500 to-teal-500 hover:bg-teal-700 text-white px-8 py-3 rounded-full font-semibold shadow-lg"
//             >
//               👉 Enroll Now
//             </motion.div>
//             </Link>
//             <motion.button
//               whileHover={{ scale: 1.05 }}
//               className="bg-green-300 hover:bg-green-500 text-teal-800 px-8 py-3 rounded-full font-semibold shadow-lg flex items-center gap-2"
//             >
...
//         <div className="absolute w-[600px] h-[600px] bg-teal-200/40 blur-3xl rounded-full top-20 left-20 animate-pulse"></div>
...
//           <h2 className="text-4xl font-serif text-teal-700 mb-8">🎥 Vastu Shastra Lecture Videos</h2>
...
//                   <Play className="text-white w-14 h-14 bg-teal-600 p-3 rounded-full shadow-lg" />
//                 </div>
...
//       <section className="py-20 px-6 bg-gradient-to-b from-green-50 to-teal-50">
//         <motion.div
...
//               {/* Month Header */}
//               <div className="flex items-center mb-4 border-b-2 border-teal-300 pb-2">
//                 {month.icon}
...
//                   <span className="text-sm font-medium text-teal-500 bg-teal-100 px-3 py-1 rounded-full">
//                     {month.duration}
//                   </span>
//                 </h3>
//               </div>
...
//             <motion.button 
//               whileHover={{ scale: 1.05 }}
//               className={`px-8 py-3 text-lg font-medium text-white rounded-full shadow-xl transition-transform transform bg-gradient-to-r from-green-600 to-teal-600 active:scale-95`}
//             >
...
//         <div className="max-w-4xl mx-auto text-center p-8 border-4 border-dashed border-teal-300 rounded-3xl bg-green-50">
//             <h2 className="text-4xl font-serif text-teal-700 mb-6 flex justify-center items-center gap-3">
//                 <Gift className="w-8 h-8 text-teal-600 animate-bounce"/> 
//                 🏠 <span className="font-bold">Bonus Section</span> – Limited Time!
//             </h2>
//             <p className="text-2xl font-bold text-teal-800 mb-6">
...
//                         className="p-4 bg-white rounded-xl shadow-lg border border-teal-100 flex items-center justify-center text-center"
//                     >
...
//       <section className="py-20 px-6 bg-gradient-to-r from-teal-100 via-green-50 to-teal-100">
...
//                 <p className="mt-3 text-teal-700 font-semibold">⭐⭐⭐⭐⭐ — {t.name}</p>
//               </motion.div>
//             ))}
//           </div>
//         </div>
...
//       {/* Contact */}
//       <section id="contact" className="py-20 px-6 bg-gradient-to-b from-green-50 to-teal-50">
//         <div className="max-w-3xl mx-auto text-center">
//           <h2 className="text-4xl font-serif text-teal-700 mb-8">📩 Contact / Help</h2>
//           <p>💌 Email: support@vastuvedic.com</p>
//           <p>📱 WhatsApp: +91 9876543210</p>
//           <motion.button
//             whileHover={{ scale: 1.05 }}
//             className="mt-6 bg-gradient-to-r from-green-600 to-teal-600 hover:bg-teal-700 text-white px-8 py-3 rounded-full font-semibold shadow-lg"
//           >
...
export default function VastuShastraCourseDetails() {
  ...
  const courseTitle = "Vastu Shastra Course: Master the Science of Space";
  ...
  return (
    <div className={`font-sans text-gray-800 ${BACKGROUND_GRADIENT} overflow-hidden`}>
      ...
      {/* Contact */}
      <section id="contact" className={`py-20 px-6 ${BACKGROUND_GRADIENT}`}>
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-serif text-red-700 mb-8">📩 Get Support</h2>
          <p className="text-lg">💌 Email: vastu@vastuscience.com</p>
