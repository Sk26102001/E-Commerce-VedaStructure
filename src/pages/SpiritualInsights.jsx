...
//     author: "Ajay Sharma",
//     date: "14-Apr-2025",
//     img: "https://i.ibb.co/0YC6bTt/vedic.png",
//   },
//   {
//     id: 2,
...
//         <h3 className="text-2xl font-bold text-gray-800">Spiritual Insights</h3>
//         <p className="mt-4 text-gray-600">
//           Explore our collection of articles on astrology, spirituality, and
//           ancient wisdom for modern living.
//         </p>
//         <button className="mt-6 px-6 py-3 bg-yellow-400 text-white font-semibold rounded-xl shadow hover:bg-yellow-500 transition">
...
//           <motion.div
//             key={item.id}
//             className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-200 hover:border-yellow-400 cursor-pointer"
//             whileHover={{ y: -10, scale: 1.03, boxShadow: "0px 10px 25px rgba(0,0,0,0.2)" }}
//             transition={{ type: "spring", stiffness: 200 }}
//           >
//             {/* Image */}
//             <div className="relative">
//               <img src={item.img} alt={item.title} className="w-full h-48 object-cover" />
//               <span className="absolute top-3 left-3 bg-yellow-400 text-white px-3 py-1 text-sm font-medium rounded-lg shadow">
//                 {item.category}
//               </span>
//             </div>
